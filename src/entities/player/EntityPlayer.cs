    ...
    public class EntityPlayer : EntityLiving
    {
        ...
        public override Texture2D[] ImageHandle
        {
            get
            {
                ...
                {
                    default:
                        return Game.I.CurrentGender == PlayerGender.Male ? ResourceUtility.BigPlayer : ResourceUtility.BigPlayerFemale;
                    case PlayerForm.Ice:
                        return Game.I.CurrentGender == PlayerGender.Male ? ResourceUtility.IcePlayer : ResourceUtility.IcePlayerFemale;
                    case PlayerForm.Magic:
                        return Game.I.CurrentGender == PlayerGender.Male
        ...
        public override void OnUpdate(Vector p, IDrawable d)
        {
            ...
            sprite.Location = new Vector(p.X, p.Y + ((Game.I.Tick % 8 < 4) && (PowerupTime > 0) ? 16 : 0));
        }
