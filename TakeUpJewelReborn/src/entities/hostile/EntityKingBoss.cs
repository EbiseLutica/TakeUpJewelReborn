            ...
            switch (_nowBehavior)
            {
                ...
                case KingBossBehaviorOption.Waiting1:
                    ...
                    if (Tick == 0)
                    {
                        ...
                        Tick = 120;
                        Parent.Add(Game.I.EntityRegister.CreateEntity("Bunyo", new Vector(Location.X, Location.Y - 16), Mpts, Map,
                            Parent));
                ...
                case KingBossBehaviorOption.JumpToRight:
                    ...
                    if (((Location.X >= _firstLoc.X) && (Location.X >= Game.I.CurrentMap.Size.X - 1)) ||
