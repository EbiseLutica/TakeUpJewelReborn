...
namespace TakeUpJewel.Util
{
    ...
    public static class ParticleUtility
    {
        ...
        {
            if (Tick % 65 == 0)
                origin.Parent.Add(Core.I.EntityRegister.CreateEntity("Bubble",
        ...
        public static void WaterSplash(Entity origin)
        {
            for (var i = 0; i < 13 + GetRand(4); i++)
                origin.Parent.Add(Core.I.EntityRegister.CreateEntity("WaterSplash",
        ...
        public static void BrokenBlock(Point pos, EntityList collection, Object[] mptobjects)
        {
            for (var i = 0; i < 3 + GetRand(3); i++)
                collection.Add(Core.I.EntityRegister.CreateEntity("BrokenBlock",
