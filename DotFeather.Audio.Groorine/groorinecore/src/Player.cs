...
namespace Groorine
{
	...
	public class Player : BindableBase
	{
		...
		public class Track
		{
			...
			public IInstrument GetCurrentInstrument() => (AudioSourceManager.Instance).Instruments[ProgramChange];

			public InstrumentList GetDrumsets() => (AudioSourceManager.Instance).Drumset;
